...
def main():
    ...
    lines.append(unlucky_games[["match_id", "p_win_10min", "gold_diff_10", "xp_diff_10", "cs_diff_10", "kills_diff_10", "dragon_kills_diff_10", "plates_diff_10"]].to_string(index=False))

    lines.append("\nTop 10 most 'lucky' wins (low p_win but win):")
    lucky_games = df[df["win"] == True].sort_values("p_win_10min", ascending=True).head(10)
    lines.append(lucky_games[["match_id", "p_win_10min", "gold_diff_10", "xp_diff_10", "cs_diff_10", "kills_diff_10", "dragon_kills_diff_10", "plates_diff_10"]].to_string(index=False))
